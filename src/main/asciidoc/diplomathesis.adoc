...
//TODO: Worum gehts (social media platform), es werden verschiedene Architekturmuster besprochen und verglichen, "In this work I discuss [..] I present different approaches to backend design. In the implementation chapters we present the backend implementation via AWS Lambda. The serverless architecture made if sign. easier to [..]. We found out that for such kind of application [..] the serverless architecture [..] scaling performance."
<WIP>
...
//TODO: More detailed description of app

Since the organization has members all over the world, the social network was supposed to be both highly scalable and available (with constant access speeds all across the globe). This paper shows the design process and theoretical aspects of such an architecture.
...
In this thesis, I will first show the theoretics of designing a cloud architecture. After that, I will go into general aspects of designing and developing a social network and analyze an existing social networking platform. I will conclude with both our initial approach and final cloud design.

<<<

== 3. Application Architectures

//TODO: In this chapter I am going to present...
...
//TODO: Specific example. First explain controller difference, then service, then persistence - red string

==== 7.3.1 Spring Boot JPA Repository vs Node.js MySQL repository
...
==== 7.3.2 Spring Boot Controller vs Node.js AWS Lambda Hook
...
<WIP>
//TODO: Mention performance benchmark
...
//TODO: Summarize: we started out developing a microservice architecture, due to problems [..] had to change architecture; analyzed different solutions; did benchmarks; noticed serverless performs better

//TODO: Flatter yourself with cool parts of the project
...
//TODO: As we found out through performance benchmarks [..]
...
- [[[monolith,4]]] Introduction to Monolithic Architecture and MicroServices Architecture: https://medium.com/koderlabs/introduction-to-monolithic-architecture-and-microservices-architecture-b211a5955c63
- [[[layered-architecture,5]]] 1. Layered Architecture - Software Architecture Patterns [Book]: https://www.oreilly.com/library/view/software-architecture-patterns/9781491971437/ch01.html
- [[[monolith-codingthearchitecture,6]]] What is a Monolith? - Coding the Architecture: http://www.codingthearchitecture.com/2014/11/19/what_is_a_monolith.html
- [[[monolith-doomed,7]]] Are Monolithic Software Applications Doomed for Extinction? - Nortal: https://nortal.com/de/blog/are-monolithic-software-applications-doomed-for-extinction/
- [[[microservices-history,8]]] Microservices: What They Are and Why Use Them: https://blog.leanix.net/en/a-brief-history-of-microservices
- [[[microservices-krakow,9]]] 33rd Degree - Conference for Java Masters - Micro services - Java, the Unix Way: http://2012.33degree.org/talk/show/67; http://2012.33degree.org/pdf/JamesLewisMicroServices.pdf
- [[[microservices-fowler,10]]] Microservices: https://martinfowler.com/articles/microservices.html
- [[[microservices-medium,11]]] Talking microservices with the man who made Netflix’s cloud famous: https://medium.com/s-c-a-l-e/talking-microservices-with-the-man-who-made-netflix-s-cloud-famous-1032689afed3
- [[[microservices-cicd,12]]] Continuous Deployment and Monitoring of Microservices - DevOps.com: https://devops.com/continuous-deployment-monitoring-microservices/
- [[[microservices-dzone,13]]] Monolithic vs Microservice Architecture - DZone Integration: https://dzone.com/articles/monolithic-vs-microservice-architecture

- [[[fowler-serverless, 14]]] Serverless Architectures: https://martinfowler.com/articles/serverless.html
- [[[serverless-bw, 15]]] Serverless Computing, Explained - Boolean World: https://www.booleanworld.com/serverless-computing-explained/
- [[[hypecycle, 16]]] Top Trends in the Gartner Hype Cycle for Emerging Technologies, 2017 - Smarter With Gartner: https://www.gartner.com/smarterwithgartner/top-trends-in-the-gartner-hype-cycle-for-emerging-technologies-2017/
- [[[serverless-cb, 17]]] Why “serverless” architecture isn’t the HOLY GRAIL (yet): https://codeburst.io/why-serverless-architecture-isnt-the-holy-grail-yet-94a095325fa4
- [[[aws-kinesis, 18]]] Amazon Kinesis: https://aws.amazon.com/kinesis/
- [[[aws-lambda, 19]]] AWS Lambda – Serverless Compute - Amazon Web Services: https://aws.amazon.com/lambda/
- [[[aws-dynamodb, 20]]] Amazon DynamoDB - Overview: https://aws.amazon.com/dynamodb/

- [[[threshold-scaling, 21]]] M. Mohan Murthy, H. Sanjay and Jumnal Anand. Threshold Based Auto Scaling of Virtual Machines in Cloud Environment https://hal.inria.fr/hal-01403090/document
- [[[serverless-scaling, 22]]] Serverless at Scale: Serving StackOverflow-like Traffic - Binaris Blog: https://blog.binaris.com/serverless-at-scale/
- [[[gcloud,23]]] - Google Cloud including GCP & G Suite — Try Free  |  Google Cloud: https://cloud.google.com/
- [[[aws, 24]]] - Amazon Web Services (AWS) - Cloud Computing Services: https://aws.amazon.com/
- [[[azure,25]]] - Microsoft Azure Cloud Computing Platform & Services: https://azure.microsoft.com/en-us/
- [[[public-vs-private-cloud, 26]]] - Is there a point where a private cloud is cheaper than the public cloud? | Network World: https://www.networkworld.com/article/2825994/is-there-a-point-where-a-private-cloud-is-cheaper-than-the-public-cloud.html
- [[[public-cloud-pro, 27]]] 10 business benefits of moving to public cloud: https://www.clariontech.com/blog/10-business-benefits-of-moving-to-public-cloud
- [[[hybrid-cloud-challenges, 28]]] What Are The Major Challenges Of Adopting A Hybrid Cloud Approach? - MiCORE Solutions: https://micoresolutions.com/major-challenges-adopting-hybrid-cloud-approach/
- [[[day-2, 29]]] Defining Day-2 Operations - DZone Agile: https://dzone.com/articles/defining-day-2-operations
- [[[dcos, 30]]] The Definitive Platform for Modern Apps | DC/OS: https://dcos.io/
- [[[why-dcos, 31]]] Why DC/OS | DC/OS: https://dcos.io/why-dcos/
- [[[openshift, 32]]] OpenShift: Container Application Platform by Red Hat, Built on Docker and Kubernetes: https://www.openshift.com/
- [[[orchestration-wiki, 33]]] Orchestration (computing) - Wikipedia: https://en.wikipedia.org/wiki/Orchestration_(computing)
- [[[aws-elb, 34]]] Elastic Load Balancing – Cloud-Load Balancer: https://aws.amazon.com/elasticloadbalancing/
- [[[aws-vpc, 35]]] Amazon Virtual Private Cloud (VPC): https://aws.amazon.com/vpc/
- [[[aws-r53, 36]]] Amazon Route 53 - Amazon Web Services: https://aws.amazon.com/route53/
- [[[aws-ec2, 37]]] Amazon EC2: https://aws.amazon.com/ec2/
- [[[digitalocean, 38]]] DigitalOcean - Cloud Computing, Simplicity at Scale: https://www.digitalocean.com/
- [[[do-price, 39]]] Pricing on DigitalOcean - Cloud virtual machine & storage pricing: https://www.digitalocean.com/pricing/#Compute
- [[[aws-price, 40]]] EC2 Instance Pricing – Amazon Web Services (AWS): https://aws.amazon.com/ec2/pricing/on-demand/
- [[[apache-server, 41]]] Welcome! - The Apache HTTP Server Project: https://httpd.apache.org/
- [[[php-usage, 42]]] Usage Statistics and Market Share of Server-side Programming Languages for Websites, March 2019: https://w3techs.com/technologies/overview/programming_language/all
- [[[mysql-usage, 43]]] DB-Engines Ranking - popularity ranking of database management systems: https://db-engines.com/en/ranking
- [[[hhvm, 44]]] HHVM | HHVM: https://hhvm.com/
- [[[memcached, 45]]] memcached - a distributed memory object caching system: http://memcached.org/
- [[[fb-stack, 46]]] Exploring the Software Behind Facebook, the World's Largest Social Media Site - Pingdom Royal: https://royal.pingdom.com/the-software-behind-facebook/
- [[[haystack-paper, 47]]] D. Beaver, S. Kumar, H.C. Li, J. Sobel and P. Vajgel. Finding a needle in Haystack: Facebook’s photo storage https://www.usenix.org/legacy/event/osdi10/tech/full_papers/Beaver.pdf
- [[[hadoop, 48]]] The Apache Hadoop project: https://hadoop.apache.org/
- [[[hive, 49]]] The Apache Hive project: https://hive.apache.org/
- [[[fb-first-server, 50]]] R. Empson. Facebook’s First Server Cost $85/Month, TechCrunch, 2012 https://techcrunch.com/2012/10/20/facebooks-first-server-cost-85month/
- [[[dns-lb, 51]]] Y.S. Hong, J.H. No and S.Y. Kim. DNS-based load balancing in distributed Web-server systems https://ieeexplore.ieee.org/abstract/document/1611743
- [[[spring, 52]]] Spring Boot: https://spring.io/projects/spring-boot
- [[[netflix-zuul, 53]]] Netflix/zuul: Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.: https://github.com/Netflix/zuul
- [[[netflix-eureka, 54]]] Netflix/eureka: AWS Service registry for resilient mid-tier load balancing and failover.: https://github.com/Netflix/eureka
- [[[logstash, 55]]] Logstash: Collect, Parse, Transform Logs | Elastic: https://www.elastic.co/products/logstash
- [[[elastic, 56]]] Elasticsearch: RESTful, Distributed Search & Analytics | Elastic: https://www.elastic.co/products/elasticsearch
- [[[kibana, 57]]] Kibana: Explore, Visualize, Discover Data | Elastic: https://www.elastic.co/products/kibana
- [[[neo4j-mysql-friends, 58]]] How much faster is a graph database, really? - Neo4j Graph Database Platform: https://neo4j.com/news/how-much-faster-is-a-graph-database-really/
- [[[couchbase, 59]]] NoSQL Engagement Database | Couchbase: https://www.couchbase.com/
- [[[spring-pivotal, 60]]] Guides: https://spring.io/guides
- [[[spring-baeldung, 61]]] Baeldung | Java, Spring and Web Development tutorials: https://www.baeldung.com/
